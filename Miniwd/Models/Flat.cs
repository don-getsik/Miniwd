...
namespace Miniwd.Models
{
    public class Flat
    {
        ...
        [Range(1, 5, ErrorMessage = "Prosze wybrać ocenę lokalizacji mieszkania/pokoju z oferty")]
        ...
        [Range(1, int.MaxValue, ErrorMessage = "Proszę podać cenę z oferty większą niż 1zł")]
        ...
        [Range(1, 5, ErrorMessage = "Proszę wybrać standard pokoju/mieszkania z oferty")]
        public int Standard { get; set; } //Standard mieszkania

        [Required(ErrorMessage = "Prosze podać piętro")]
        [Range(0, int.MaxValue, ErrorMessage = "Proszę podać piętro większe lub równe 0")]
        ...
        [Range(1, int.MaxValue, ErrorMessage = "Proszę podać preferowaną liczbę pokoi większą lub równą 1")]
        ...
        [Range(1, 5, ErrorMessage = "Proszę podać preferowany standard pokoju/mieszkania")]
        ...
        [Range(1, 5, ErrorMessage = "Prosze podać preferowaną ocenę lokalizacji mieszkania/pokoju")]
